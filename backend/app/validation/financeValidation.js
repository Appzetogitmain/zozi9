...
export const checkoutPreviewSchema = Joi.object({
  ...
  deliveryType: Joi.string().valid("express", "scheduled").default("express"),
  scheduledDate: Joi.date().iso().optional(),
  scheduledSlot: Joi.object({
...
export const updateDeliverySettingsSchema = Joi.object({
  ...
  riderBaseFare: Joi.number().min(0).optional(),
  riderIncludedKm: Joi.number().min(0).optional(),
  riderExtraKmRate: Joi.number().min(0).optional(),
  riderSurgeMultiplier: Joi.number().min(1).optional(),
