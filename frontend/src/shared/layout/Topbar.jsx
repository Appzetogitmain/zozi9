    ...
    return (
        <header className={cn(
            ...
            {settings?.maintenanceMode?.enabled && (
                <div className="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center gap-2 px-4 py-1.5 bg-red-100 text-red-700 rounded-full text-xs font-bold shadow-sm border border-red-200">
